...
public class GenerateEntityOracle {
	//private String packageOutPath = "com.project.model";//指定实体生成所在包的路径 
	private String packageOutPath="d://build";
	 private String authorName = "walden";//作者名字 
	 private String tablename = "ACT_CUSTOM_PROCESS";//表名 
	 ...
	 /**
	  * 
	  * @param packageOutPath 生产实体类的存储路径
	  * @param authorName  作者姓名
	  * @param tablename   表名
	  */
	public GenerateEntityOracle(String packageOutPath, String authorName, String tablename) {
		super();
		this.packageOutPath = packageOutPath;
		this.authorName = authorName;
		this.tablename = tablename;
	}
	public void EntityOracle() {
	  //创建连接 
	  Connection conn;
	  //查要生成实体类的表 
	  ...
	  // String outputPath = directory.getAbsolutePath()+ "/src/"+this.packageOutPath.replace(".", "/")+"/"+initcap(handleEntityName(tablename.toLowerCase())) + ".java"; 
	   String outputPath=this.packageOutPath+"/"+initcap(handleEntityName(tablename.toLowerCase())) + ".java";
